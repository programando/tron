...
<div class="col-lg-3 col-md-3  col-sm-3 columna-presentacion-producto">
        ...
        <div class="presentacion_del_producto"><!--No se Olvide De Insertar IMG-Ampliada Del Producto -- >
          ...
          <div class="porductos-tron-img_producto"id="cont-img-producto-pisos">
       ...
       <p class="text-center  precio_del_cliente_tron"> <strong id ='vr_unitario_pisos'>
       <?= $text_pv_tron ;?>   </strong><!--contenedor = Precio-Cliente TRON-->
