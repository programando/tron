      ...
      <div><!--Contenedor de la tanla de seleccion de planes -->
          <table class="table table-condenced table-hover"><!--Tabla -->
             ...
             <tbody><!--Cuerpo de la tabla -->
                ...
                <tr>
                   <td> <strong>
                          <a class="nuvv" title="Por amigos que se inscriban a la red con tu código de usuario y por los que inscriban tus amigos y los amigos de tus amigos hasta 6 niveles de profundidad.">
                              BONIFICACIONES
                          </a>
                        </strong> </td>
                   <td class="text-center"><img src="<?= BASE_IMG_TIENDA ;?>negativo-rojo.png "></td>
                 ...
                 <tr>
                   <td> <strong>
                          <a class="nuvv" title="Año tras año, los miembros de tu Red renovarán el Derecho de Permanencia y por ello recibirás una prima.">
                              PRIMAS ANUALES
                          </a>
                        </strong> </td>
                   <td class="text-center"><img src="<?= BASE_IMG_TIENDA ;?>negativo-rojo.png "></td>
