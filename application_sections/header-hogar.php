...
<!-- Menu -->
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse" style="border : red solid 2px; height: 5px; min-height: 10px;">
          <ul class="nav navbar-nav">
            ...
            <li><a class="list-menu campo_2" id="hogar_otros"  style="border : red solid 2px; height: 5px; min-height: 25px;"    href="<?=BASE_URL ;?>productos/categorias_marcas/">OTROS PRODUCTOS</a></li>
            <li><a class="list-menu campo_3" id="hogar_destacados" style="border : red solid 2px; height: 5px; min-height: 25px;" href="<?=BASE_URL ;?>productos/destacados/">DESTACADOS</a></li>
            <li><a class="list-menu campo_4" id="hogar_ofertas"  style="border : red solid 2px; height: 5px; min-height: 25px;"   href="<?=BASE_URL ;?>productos/ofertas/">OFERTAS</a></li>
            <li><a class="list-menu campo_5" id="hogar_novedades"  style="border : red solid 2px; height: 5px; min-height: 25px;" href="<?=BASE_URL ;?>productos/novedades/">NOVEDADES</a></li>
            <li><a class="list-menu campo_6"                 style="border : red solid 2px; height: 5px; min-height: 25px;"      href="<?=BASE_URL ;?>redtron/contactanos">CONTACTOS</a></li>
