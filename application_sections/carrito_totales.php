  ...
  <td colspan="6" class="text-right">
        ...
        <?php if (Session::Get('logueado') == FALSE): ; ?>
            <?php if ( Session::Get('cobrar_fletes') == TRUE ) :?>
                <div class="col-resumen-pedido"><strong>Transporte y Recaudo <small>( Calculado para Cali ):</small></strong></div>
                <?php else : ?>
        ...
        <?php else : ?>
             <?php if ( Session::Get('cobrar_fletes') == TRUE ) :?>
                <div class="col-resumen-pedido"><strong>( + ) Transporte y Recaudo <small>( <?= Session::Get('nommcipio_despacho') ;?> ):</small> </strong></div>
                <?php else : ?>
