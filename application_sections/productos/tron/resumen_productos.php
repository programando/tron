...
?>
			...
			<tr class="fila_por_producto">
				<td id='datos-producto tab'>
					...
					<!-- Borrar producto -->
					<div class="borrar-producto" cantidad='<?= $cantidad ; ?>' idproducto = '<?= $idproducto ; ?>'>
                        <small>
                            <span id='btn-borrar-resumen' class="glyphicon glyphicon-trash  resumen-pedido-img" title="Borrar del Pedido" cantidad= '<?= $cantidad ; ?>' idproducto= '<?= $idproducto ; ?>'></span>
                        </small>
					</div>
				</td>
			</tr>
