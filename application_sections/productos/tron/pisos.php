...
<div class="presentacion_del_producto mb10">
    <div id="cont-img-producto-pisos" class="mb10 taC">
        <img src="<?= BASE_IMG_PRODUCTOS_TRON ;?>pisos_producto.jpg" />
    </div>
    <p class="taC nombre_del_producto">
        Concentrado Limpiador Desinfectante Multiusos y Pisos
    </p>
</div>
...
<div class="precio_del_producto">
    <p class="text-center precio_publico-ocacional"> <strong> <?=   $text_pv_comprador_ocasional_pisos ;?> </strong><!--contenedor = Precio-Ocacional-->
