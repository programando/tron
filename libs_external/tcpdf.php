...
require_once('tcpdf_include/tcpdf_config.php');
require_once('tcpdf_include/spa.php');

// TCPDF static font methods and data
require_once('tcpdf_include/tcpdf_font_data.php');
// TCPDF static font methods and data
require_once('tcpdf_include/tcpdf_fonts.php');
// TCPDF static color methods and data
require_once('tcpdf_include/tcpdf_colors.php');
// TCPDF static image methods and data
require_once('tcpdf_include/tcpdf_images.php');
// TCPDF static methods and data
require_once('tcpdf_include/tcpdf_static.php');
