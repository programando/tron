     ...
     public function Finalizar_Pedido_Forma_Pago( $idpedido = 0)  {
       ...
       if ( $Vr_Total_Pedido_Real > 0 ){
        ...
        if ( $TipoUsuario == 3 ){
         ...
         $this->View->Mostrar_Vista('finalizar_pedido_forma_pago'); //$this->View->Mostrar_Vista('pedido_pago_cero');
        }
      }
    }
  ...
  public function Mostrar_Carrito() {
      ...
      */
      ...
      if ($this->Cantidad_Filas_Carrito > 0)  {
        ...
        $this->View->Vr_Transporte_Real      =   0  ;
        $this->View->Vr_Transporte_Ocasional =   0 ;
        $this->View->Vr_Transporte_Tron      =   0  ;
